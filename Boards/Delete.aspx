<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Delete.aspx.cs" Inherits="OnlineAdvertisement.Boards.Delete" %>
<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
<title>Online Advertisement | Delete </title>
<!-- for-mobile-apps -->
...
<link rel="stylesheet" href="../css/bilboardDelete.css"/>
...
<body>
   ...
   <a class="nav-content" href="../createPoster.aspx">Poster Making</a>
    ...
    <div class="container">
		<h2> Delete Bill Board</h2>
    <div class="data">
        <div class="col-md-8">
     Mode
     <asp:TextBox ID="manager" runat="server" CssClass = "form-control" ></asp:TextBox>
 </div>
 ...
 <div class="col-md-8">
     Description
     <asp:TextBox ID="addsDesc" runat="server" class = "form-control" ></asp:TextBox>
 </div>
 <div class="col-md-8">
     Date
    <input  type="Date" id="publishDate"  runat="server" class = "form-control"/>
 </div>
 <div class="col-md-8">
     For What
    <input  type="text" id="purpose"  runat="server"  class = "form-control"/>
 </div>
 <div class="col-md-offset-6 col-md-6" style="margin-top:20px;">
     <asp:Button ID="Submit" runat="server" class="btn btn-danger" Text=" Delete " OnClick="Submit_Click"/>
 </div> 
    </div>
			     <div class="col-md-8">
