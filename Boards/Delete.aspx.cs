...
namespace OnlineAdvertisement.Boards
{
    public partial class Delete : System.Web.UI.Page
    {
        ...
        {
            if (Operations.DB_Operation("Delete From Billboards Where Id=" + Operations.Id))
            {
                lblMessage.InnerHtml = "Billboard Details has been Deleted Successfully. <a href='/Boards/View.aspx'>View All</a> ";
            }
            else
            {
                lblMessage.InnerText = "Oops ! Billboard Details has not been Deleted ! Try Again";
            }
        }
    }
}