<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminViewBillboards.aspx.cs" Inherits="OnlineAdvertisement.adminViewBillboards" %>
...
<body>
  ...
  <div class="col-lg-12">
    ...
    <ItemTemplate>
        <asp:Button ID="btnDownload" CssClass="btn" runat="server" Text="Download" OnClick="DownloadImage_Click" CommandArgument='<%# Eval("Id") %>' />
    </ItemTemplate>
</asp:TemplateField>
        ...
        <asp:BoundField  HeaderStyle-BackColor="White" DataField="addsDesc" HeaderText="Description" />
 ...
 <asp:Label ID="lblStatus" runat="server" Text='<%# GetStatusString(Convert.ToInt32(Eval("status"))) %>'></asp:Label>     </ItemTemplate>
      ...
      <ItemTemplate>
		 <asp:Button ID="btnUpdateStatus" runat="server" Text="Approved" CssClass="btn btn-success" OnClick="btnUpdateStatus_Click"  CommandArgument='<%# Eval("Id") %>' />
