<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adsDetails.aspx.cs" Inherits="OnlineAdvertisement.adsDetails" %>
    ...
    <div class="header">
        ...
        <div class="nav">
          <ul id="ul">
            <li>
                 ...
                 <a class="nav-content" href="../Boards/View.aspx">Billboards Management</a>
      ...
      <div class="container">
        ...
        <div class="inner inner1">
          ...
          <a class="btn" href="./Adds.aspx">Click Here to Advertise</a>
          <div class="adtpyes">
            <div class="adtpyes">
