<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="main.aspx.cs" Inherits="OnlineAdvertisement.main" %>
<!DOCTYPE html>
      ...
      <div class="container">
        <div class="online">
          <div  data-aos-duration="800"data-aos="flip-left"class="content">
            ...
            <a class="btn2" href="../frmLogin.aspx">Login / Signup</a>
          </div>
          <div class="rimg">
        ...
        <div class="billboard">
          <a class="btn" href="../details.aspx">Ads Details</a>
        </div>
