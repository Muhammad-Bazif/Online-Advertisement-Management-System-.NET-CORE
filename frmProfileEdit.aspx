<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmProfileEdit.aspx.cs" Inherits="OnlineAdvertisement.frmProfileEdit" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
<title>Online Advertisement | Update Profile </title>
<!-- for-mobile-apps -->
...
<link href='//fonts.googleapis.com/css?family=Open+Sans:400,300,300italic,400italic,600,600italic,700,700italic,800,800italic' rel='stylesheet' type='text/css'/>
    ...
    <link rel="stylesheet" href="./css/PUpdate.css"/>
</head>
<body>
