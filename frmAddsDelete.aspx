<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmAddsDelete.aspx.cs" Inherits="OnlineAdvertisement.frmAddsDelete" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
<title>Online Advertisement | Delete Adds </title>
<!-- for-mobile-apps -->
...
<link rel="stylesheet" href="./css/adsDelete.css" />
</head>
<body>
      <form runat="server">
    <div class="header">
   ...
   <a class="nav-content" href="./createPoster.aspx">Poster Making</a>
    ...
    <div class="container">
        ...
        <div class="login-form-grids animated wow slideInUp" data-wow-delay=".5s">
                ...
                <input type="text" runat="server" class="form-control" placeholder="Enter Cost" id="txtBudget" required=" " /><br />
                <input type="date" runat="server" class="form-control"  id="txtDate" required=" " /><br />
             <asp:Button ID="btnDelete" runat="server" CssClass="btn btn-info" OnClick="btnDelete_Click" Text="     Delete     " /><br />
